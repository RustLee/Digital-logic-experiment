...
HD_PWD='E:/lqyproject_1/lqyproject_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ex_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ex_1.tcl -notrace
