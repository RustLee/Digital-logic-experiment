...
HD_PWD='E:/fulladd1/fulladd1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladd1io_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladd1io_wrapper.tcl
