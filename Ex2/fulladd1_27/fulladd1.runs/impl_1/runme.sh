...
HD_PWD='E:/fulladd1/fulladd1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladd1io_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fulladd1io_wrapper.tcl -notrace
